...
- Observed model cost (USD): `$0.000000000000`
- Provider-reported cost complete: `False`
...
- Incomplete accounting: missing_usage=`0`, invalid_usage=`0`, no_response=`2`, pending=`0`

| Stage | Attempts | Input | Cache | Output | Observed USD |
| ----- | -------- | ----- | ----- | ------ | ------------ |
| `planner_decompose` | 2 | 0 | 0 | 0 | 0.000000000000 |
