...
# Add sub_scripts directory to sys.path so we can import category-specific modules cleanly
sys.path.append(os.path.join(_SCRIPT_DIR, 'sub_scripts'))
...
def main():
    ...
    if requires_llm and OpenAI is None:
        ...
        print("Install the 'openai' package or run a deterministic Model/Skill ingestion.")
        sys.exit(1)
    ...
    if requires_llm:
        ...
        key_source = "not required for rule-based Model ingestion"
        masked_key = "n/a"
